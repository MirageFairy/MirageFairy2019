...
object Fairy {
    ...
    val fairyModule = module {
        ...
        onMakeLang {
            ...
            enJa("mirageFairy2019.fairy.enderDragon.name", "Endere Dragonia", "終界龍精エンデレドラゴーニャ")
            enJa("mirageFairy2019.fairy.witherSkeleton.name", "Withere Dkeletonia", "枯骸骨精ウィーテレスケレトーニャ")
            ...
            enJa("mirageFairy2019.fairy.magentaGlazedTerracotta.name", "Magente Glazede Terracottia", "赤紫釉陶精マゲンテグラゼデテッラツォッチャ")
            ...
            enJa("mirageFairy2019.fairy.craftingTable.name", "Craftinge Tablia", "作業台精ツラフティンゲターブリャ")
            ...
            enJa("mirageFairy2019.fairy.netherStar.name", "Nethere Staria", "地獄星精ネテーレスターリャ")
            enJa("mirageFairy2019.fairy.brewingStand.name", "Brewinge Standia", "醸造台精ブレウィンゲスタンジャ")
            ...
            enJa("mirageFairy2019.fairy.santaClaus.name", "Sante Clausia", "聖夜老人精サンテツラウシャ")
            enJa("mirageFairy2019.fairy.ice.name", "Icia", "氷精イーツァ")
            enJa("mirageFairy2019.fairy.packedIce.name", "Packede Icia", "氷塊精パッケデイーツァ")
            enJa("mirageFairy2019.fairy.golem.name", "Golemia", "鉄魔像精ゴレーミャ")
            enJa("mirageFairy2019.fairy.glass.name", "Glassia", "硝子精グラッシャ")
            enJa("mirageFairy2019.fairy.activatorRail.name", "Activatore Railia", "活性軌条精アツティヴァトーレライリャ")
            enJa("mirageFairy2019.fairy.ironBars.name", "Irone Barsia", "鉄格子精イローネバルシャ")
            ...
            enJa("mirageFairy2019.fairy.darkChocolate.name", "Darke Chocolatia", "濃智代子齢糖精ダルケキョツォラーチャ")
            enJa("mirageFairy2019.fairy.enchantedGoldenApple.name", "Enchantede Goldene Applia", "付魔金林檎精エンキャンテーデゴルデーネアップーリャ")
            enJa("mirageFairy2019.fairy.fortune.name", "Fortunia", "幸運精フォルトゥーニャ")
            enJa("mirageFairy2019.fairy.rottenFlesh.name", "Rottene Fleshia", "腐肉精ロッテーネフレーシャ")
            enJa("mirageFairy2019.fairy.poisonousPotato.name", "Poisonouse Potatia", "悪芋精ポイソノウセポターチャ")
            enJa("mirageFairy2019.fairy.melon.name", "Melonia", "西瓜精メローニャ")
            enJa("mirageFairy2019.fairy.bakedPotato.name", "Bakede Potatia", "焼芋精バケーデポターチャ")
            enJa("mirageFairy2019.fairy.cookedChicken.name", "Cookede Chickenia", "焼鶏精ツォーケーデキッケーニャ")
            enJa("mirageFairy2019.fairy.cookedSalmon.name", "Cookede Salmonia", "焼鮭精ツォーケーデサルモーニャ")
            enJa("mirageFairy2019.fairy.steak.name", "Steakia", "焼牛精ステアキャ")
            enJa("mirageFairy2019.fairy.goldenApple.name", "Goldene Applia", "金林檎精ゴルデーネアップーリャ")
            enJa("mirageFairy2019.fairy.cupid.name", "Cupidia", "恋射手精ツピージャ")
            enJa("mirageFairy2019.fairy.spiderEye.name", "Spidere Eyia", "蜘蛛目精スピデーレエーヤ")
            enJa("mirageFairy2019.fairy.shulker.name", "Shulkeria", "潜影貝精シュルケーリャ")
            enJa("mirageFairy2019.fairy.slime.name", "Slimia", "吐泥精スリーミャ")
            enJa("mirageFairy2019.fairy.magmaCube.name", "Magme Cubia", "溶岩賽精マグメツービャ")
            enJa("mirageFairy2019.fairy.blaze.name", "Blazia", "烈炎精ブラージャ")
            enJa("mirageFairy2019.fairy.beetroot.name", "Beetrootia", "火焔菜精ベートローチャ")
            enJa("mirageFairy2019.fairy.pumpkinPie.name", "Pumpkine Pia", "南瓜餡餅精プンプキーネピャ")
            enJa("mirageFairy2019.fairy.beetrootSoup.name", "Beetroote Soupia", "火焔菜汁精ベートローテソウピャ")
            enJa("mirageFairy2019.fairy.eleven.name", "Elevenia", "十一精エレヴェーニャ")
            enJa("mirageFairy2019.fairy.imperialTopaz.name", "Imperiale Topazia", "皇帝黄玉精インペリアーレトパージャ")
            enJa("mirageFairy2019.fairy.door.name", "Dooria", "扉精ドーリャ")
            enJa("mirageFairy2019.fairy.ironDoor.name", "Irone Dooria", "鉄扉精イローネドーリャ")
            enJa("mirageFairy2019.fairy.redstoneRepeater.name", "Redstone Repeateria", "赤石中継器精レドストーネレペアテーリャ")
            enJa("mirageFairy2019.fairy.redstoneComparator.name", "Redstone Comparatoria", "赤石比較器精レドストーネコンパラトーリャ")
            enJa("mirageFairy2019.fairy.chorusFruit.name", "Choruse Fruitia", "紫頌果精キョルーセフルイチャ")
            enJa("mirageFairy2019.fairy.mushroomStew.name", "Mushroome Stewia", "茸煮精ムシュローメステーウャ")
            enJa("mirageFairy2019.fairy.rawRabbit.name", "Rawe Rabbitia", "生兎精ラーウェラッビーチャ")
            enJa("mirageFairy2019.fairy.mirageFlower.name", "Mirage Floweria", "妖花精ミラーゲフロウェーリャ")
            ...
            enJa("mirageFairy2019.fairy.chargedCreeper.name", "Chargede Creeperia", "巨匠精キャルゲーデツレペーリャ")
            enJa("mirageFairy2019.fairy.sugarCane.name", "Sugare Cania", "砂糖黍精スガーレツァーニャ")
            ...
            enJa("mirageFairy2019.fairy.netherPortal.name", "Nethere Portalia", "地獄門精ネテーレポルターリャ")
            enJa("mirageFairy2019.fairy.mirage.name", "Miragia", "妖精ミラージャ")
            enJa("mirageFairy2019.fairy.coalDust.name", "Coale Dustia", "石炭粉精ツォアーレドゥスチャ")
            enJa("mirageFairy2019.fairy.diamondDust.name", "Diamonde Dustia", "金剛石粉精ディアモンデドゥスチャ")
            enJa("mirageFairy2019.fairy.button.name", "Buttonia", "釦精ブットーニャ")
            enJa("mirageFairy2019.fairy.cookedCod.name", "Cookede Codia", "焼鱈精ツォーケーデツォージャ")
            ...
            enJa("mirageFairy2019.fairy.curseOfVanishing.name", "Curse Ofe Vanishingia", "消滅呪精ツルセオフェヴァニシンギャ")
            enJa("mirageFairy2019.fairy.gravity.name", "Gravitia", "重力精グラヴィーチャ")
            enJa("mirageFairy2019.fairy.pyrite.name", "Pyritia", "黄鉄鉱精ピリーチャ")
            enJa("mirageFairy2019.fairy.redSpinel.name", "Rede Spinelia", "赤尖晶石精レーデスピネーリャ")
        }
