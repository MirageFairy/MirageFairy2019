...
val fairyRelationModule = module {
    ...
    FairyCard.MAGNETITE.register { blockState({ CompressedMaterials.blockMaterials1().getState(EnumVariantMaterials1.MAGNETITE_BLOCK) }) }
    FairyCard.MAGNETITE.register { material("Magnetite") }
    FairyCard.APATITE.register { blockState({ CompressedMaterials.blockMaterials1().getState(EnumVariantMaterials1.APATITE_BLOCK) }) }
    FairyCard.APATITE.register { material("Apatite") }
    FairyCard.FLUORITE.register { blockState({ CompressedMaterials.blockMaterials1().getState(EnumVariantMaterials1.FLUORITE_BLOCK) }) }
    FairyCard.FLUORITE.register { material("Fluorite") }
    FairyCard.SULFUR.register { blockState({ CompressedMaterials.blockMaterials1().getState(EnumVariantMaterials1.SULFUR_BLOCK) }) }
    FairyCard.SULFUR.register { material("Sulfur") }
    FairyCard.CINNABAR.register { blockState({ CompressedMaterials.blockMaterials1().getState(EnumVariantMaterials1.CINNABAR_BLOCK) }) }
    FairyCard.CINNABAR.register { material("Cinnabar") }
    FairyCard.MOONSTONE.register { blockState({ CompressedMaterials.blockMaterials1().getState(EnumVariantMaterials1.MOONSTONE_BLOCK) }) }
    FairyCard.MOONSTONE.register { material("Moonstone") }
    FairyCard.PYROPE.register { blockState({ CompressedMaterials.blockMaterials1().getState(EnumVariantMaterials1.PYROPE_BLOCK) }) }
    FairyCard.PYROPE.register { material("Pyrope") }
    FairyCard.SMITHSONITE.register { blockState({ CompressedMaterials.blockMaterials1().getState(EnumVariantMaterials1.SMITHSONITE_BLOCK) }) }
    FairyCard.SMITHSONITE.register { material("Smithsonite") }
    FairyCard.NEPHRITE.register { blockState({ CompressedMaterials.blockMaterials1().getState(EnumVariantMaterials1.NEPHRITE_BLOCK) }) }
    FairyCard.NEPHRITE.register { material("Nephrite") }
    FairyCard.TOURMALINE.register { blockState({ CompressedMaterials.blockMaterials1().getState(EnumVariantMaterials1.TOURMALINE_BLOCK) }) }
    FairyCard.TOURMALINE.register { material("Tourmaline") }
    FairyCard.TOPAZ.register { blockState({ CompressedMaterials.blockMaterials1().getState(EnumVariantMaterials1.TOPAZ_BLOCK) }) }
