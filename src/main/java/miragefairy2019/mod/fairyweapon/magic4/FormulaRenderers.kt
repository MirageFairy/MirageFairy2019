...
val FormulaRendererSelector<Double>.duration2 get() = createSimpleFormulaRenderer { textComponent { (value / 20.0 formatAs "%.2f 秒")() } } // TODO translate
val FormulaRendererSelector<Double>.duration4 get() = createSimpleFormulaRenderer { textComponent { (value / 20.0 formatAs "%.4f 秒")() } } // TODO translate
