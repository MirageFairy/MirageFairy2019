...
val FormulaRendererSelector<Double>.duration2 get() = createSimpleFormulaRenderer { textComponent { (value / 20.0 formatAs "%.2f 秒")() } } // TRANSLATE
val FormulaRendererSelector<Double>.duration4 get() = createSimpleFormulaRenderer { textComponent { (value / 20.0 formatAs "%.4f 秒")() } } // TRANSLATE
val FormulaRendererSelector<Double>.pitch get() = createSimpleFormulaRenderer { textComponent { (log(value, 2.0) * 12 formatAs "%.2f")() } } // TRANSLATE
