...
class FairyWeaponLoader(m: ModInitializer) {
    ...
    val fairyWandHydrating4 = m.fw(4, ::ItemFairyWand, "hydrating_fairy_wand_4", "${fw}Hydrating4", listOf("${fw2}Hydrating", "container1000Water"), null, { WATER })
    val fairyWandMelting = m.fw(2, ::ItemFairyWand, "melting_fairy_wand", "${fw}Melting", listOf("${fw2}Melting"), null, { FLAME })
    val fairyWandMelting2 = m.fw(3, ::ItemFairyWand, "melting_fairy_wand_2", "${fw}Melting2", listOf("${fw2}Melting"), null, { FLAME })
    val fairyWandMelting3 = m.fw(4, ::ItemFairyWand, "melting_fairy_wand_3", "${fw}Melting3", listOf("${fw2}Melting"), null, { FLAME })
    val fairyWandBreaking = m.fw(2, ::ItemFairyWand, "breaking_fairy_wand", "${fw}Breaking", listOf("${fw2}Breaking"), null, { DESTROY })
    val fairyWandBreaking2 = m.fw(3, ::ItemFairyWand, "breaking_fairy_wand_2", "${fw}Breaking2", listOf("${fw2}Breaking"), null, { DESTROY })
    val fairyWandBreaking3 = m.fw(4, ::ItemFairyWand, "breaking_fairy_wand_3", "${fw}Breaking3", listOf("${fw2}Breaking"), null, { DESTROY })
    val fairyWandFreezing = m.fw(2, ::ItemFairyWand, "freezing_fairy_wand", "${fw}Freezing", listOf("${fw2}Freezing"), null, { FREEZE })
    val fairyWandFreezing2 = m.fw(3, ::ItemFairyWand, "freezing_fairy_wand_2", "${fw}Freezing2", listOf("${fw2}Freezing"), null, { FREEZE })
    val fairyWandFreezing3 = m.fw(4, ::ItemFairyWand, "freezing_fairy_wand_3", "${fw}Freezing3", listOf("${fw2}Freezing"), null, { FREEZE })
    val fairyWandPolishing = m.fw(3, ::ItemFairyWand, "polishing_fairy_wand", "${fw}Polishing", listOf("${fw2}Polishing"), null, { CRYSTAL })
    val fairyWandPolishing2 = m.fw(4, ::ItemFairyWand, "polishing_fairy_wand_2", "${fw}Polishing2", listOf("${fw2}Polishing"), null, { CRYSTAL })
