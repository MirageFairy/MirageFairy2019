...
public class ItemOcarinaTemptation extends ItemFairyWeaponBase {
    ...
    public void addInformationFairyWeapon(ItemStack itemStackFairyWeapon, ItemStack itemStackFairy, IFairyType fairyType, World world, List<String> tooltip, ITooltipFlag flag) {
        ...
        tooltip.add(TextFormatting.BLUE + "Experience Cost: " + String.format("%.1f", status.experienceCost * 100) + "% (Gaia, " + AbilityTypeKt.getDisplayName(AbilityType.Companion.getFood()).getUnformattedText() + ")");
