...
public class FormulaDoubleFormulaPowDouble implements IFormulaDouble {
     ...
     * @param b 非負でなければなりません。
     */
    public FormulaDoubleFormulaPowDouble(IFormulaDouble a, double b) {
        this.a = a;
        this.b = b;
