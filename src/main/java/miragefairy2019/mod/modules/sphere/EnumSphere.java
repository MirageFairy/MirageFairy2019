...
public enum EnumSphere
{
	...
	slash(EnumAbilityType.slash, 0xAAAAAA, 0xFFC9B2, 0xD20000, 0xFFFFFF, () -> Ingredient.fromStacks(new ItemStack(Items.SHEARS))),
	...
	christmas(EnumAbilityType.christmas, 0xFF0000, 0xFFD723, 0x00B900, 0xFF0000, () -> Ingredient.fromStacks(new ItemStack(Blocks.SAPLING, 1, 1))),
	;
