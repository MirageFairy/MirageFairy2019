...
public enum EnumSphere
{
	...
	craft(AbilityTypes.craft.get(), 0xADADAD, 0xFFC8A4, 0xB57919, 0xDCDCDC, () -> new OreIngredient("workbench")),
	fell(AbilityTypes.fell.get(), 0x00BD00, 0xD09D74, 0x6E4219, 0x2FFF2F, () -> Ingredient.fromStacks(new ItemStack(Items.IRON_AXE))),
	light(AbilityTypes.light.get(), 0xE0F8FF, 0xFFFFE0, 0xFFFFFF, 0xFFDD3E, () -> new OreIngredient("torch")),
	...
	crystal(AbilityTypes.crystal.get(), 0xA2FFFF, 0xB6FFFF, 0x36CECE, 0xEBFFFF, () -> new OreIngredient("gemDiamond")),
	...
	warp(AbilityTypes.warp.get(), 0x3A00D3, 0x8CF4E2, 0x349988, 0xD004FB, () -> new OreIngredient("enderpearl")),
	...
	energy(AbilityTypes.energy.get(), 0xFFED30, 0xFFF472, 0xFFE84C, 0xBFE7FF, () -> new OreIngredient("gemCoal")),
	...
	freeze(AbilityTypes.freeze.get(), 0x5AFFFF, 0xFFFFFF, 0xF6FFFF, 0xACFFFF, () -> new OreIngredient("ice")),
