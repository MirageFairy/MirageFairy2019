...
public class ModuleFairy
{
	...
	public static class FairyTypes
	{
		...
		{
			{
				r(0, air = v(t("air", 1, 15, m(1, 0, 10, 0, 0, 0), a(e(ATTACK, 0)), c(0xFFBE80, 0xDEFFFF, 0xDEFFFF, 0xB0FFFF))));
				r(1, water = v(t("water", 1, 50, m(0, 0, 0, 1, 10, 6), a(e(ATTACK, 4)), c(0x5469F2, 0x5985FF, 0x172AD3, 0x2D40F4))));
				r(2, fire = v(t("fire", 2, 20, m(1, 10, 0, 0, 0, 0), a(e(ATTACK, 9)), c(0xFF6C01, 0xF9DFA4, 0xFF7324, 0xFF4000))));
				r(3, sun = v(t("sun", 5, 99, m(10, 28, 24, 18, 18, 0), a(e(ATTACK, 5)), c(0xff2f00, 0xff972b, 0xff7500, 0xffe7b2))));
				r(4, stone = v(t("stone", 1, 83, m(0, 0, 0, 10, 0, 15), a(e(ATTACK, 6)), c(0x333333, 0x8F8F8F, 0x686868, 0x747474))));
				r(5, dirt = v(t("dirt", 1, 70, m(0, 0, 0, 10, 3, 28), a(e(ATTACK, 0)), c(0xB87440, 0xB9855C, 0x593D29, 0x914A18))));
				r(6, iron = v(t("iron", 2, 86, m(0, 3, 0, 10, 4, 6), a(e(ATTACK, 0)), c(0xA0A0A0, 0xD8D8D8, 0x727272, 0xD8AF93))));
				r(7, diamond = v(t("diamond", 4, 76, m(10, 13, 21, 26, 0, 0), a(e(ATTACK, 0)), c(0x97FFE3, 0xD1FAF3, 0x70FFD9, 0x30DBBD))));
				r(8, redstone = v(t("redstone", 3, 54, m(1, 35, 11, 10, 0, 6), a(e(ATTACK, 0)), c(0xFF5959, 0xFF0000, 0xCD0000, 0xBA0000))));
				r(9, enderman = v(t("enderman", 4, 48, m(1, 18, 18, 12, 10, 0), a(e(ATTACK, 11)), c(0x000000, 0x161616, 0x161616, 0xEF84FA))));
				r(10, moon = v(t("moon", 5, 95, m(10, 24, 28, 9, 9, 25), a(e(ATTACK, 0)), c(0xD9E4FF, 0x747D93, 0x0C121F, 0x2D4272))));
				r(11, sand = v(t("sand", 1, 64, m(1, 0, 0, 10, 0, 16), a(e(ATTACK, 2)), c(0xB87440, 0xEEE4B6, 0xC2BC84, 0xD8D09B))));
				r(12, gold = v(t("gold", 3, 93, m(1, 0, 9, 10, 0, 0), a(e(ATTACK, 0)), c(0xA0A0A0, 0xFFFF0B, 0xDC7613, 0xDEDE00))));
				r(13, spider = v(t("spider", 2, 43, m(0, 0, 0, 0, 10, 4), a(e(ATTACK, 10)), c(0x494422, 0x61554A, 0x52483F, 0xA80E0E))));
				r(14, skeleton = v(t("skeleton", 1, 49, m(0, 8, 10, 5, 0, 8), a(e(ATTACK, 12)), c(0xCACACA, 0xCFCFCF, 0xCFCFCF, 0x494949))));
				r(15, zombie = v(t("zombie", 1, 55, m(0, 9, 10, 0, 2, 9), a(e(ATTACK, 13)), c(0x2B4219, 0x00AAAA, 0x322976, 0x2B4219))));
				r(16, creeper = v(t("creeper", 2, 35, m(0, 0, 10, 5, 12, 4), a(e(ATTACK, 10)), c(0x5BAA53, 0xD6FFCF, 0x5EE74C, 0x000000))));
				r(17, wheat = v(t("wheat", 2, 31, m(0, 0, 0, 0, 10, 5), a(e(ATTACK, 0)), c(0x168700, 0xD5DA45, 0x716125, 0x9E8714))));
				r(18, lilac = v(t("lilac", 3, 28, m(0, 0, 1, 1, 10, 0), a(e(ATTACK, 0)), c(0x63D700, 0xF0C9FF, 0xDC8CE6, 0xA22CFF))));
				r(19, torch = v(t("torch", 1, 19, m(1, 5, 1, 10, 4, 0), a(e(ATTACK, 1)), c(0xFFFFFF, 0xFFC52C, 0xFF5800, 0xFFE6A5))));
				r(20, lava = v(t("lava", 2, 58, m(0, 22, 0, 8, 10, 0), a(e(ATTACK, 7)), c(0xCD4208, 0xEDB54A, 0xCC4108, 0x4C1500))));
				r(21, star = v(t("star", 4, 98, m(10, 16, 16, 9, 9, 38), a(e(ATTACK, 0)), c(0xffffff, 0x2C2C2E, 0x0E0E10, 0x191919))));
				r(22, gravel = v(t("gravel", 2, 77, m(0, 0, 0, 10, 0, 8), a(e(ATTACK, 3)), c(0x333333, 0xC0B5B6, 0x968B8E, 0x63565C))));
				r(23, emerald = v(t("emerald", 4, 73, m(10, 16, 15, 0, 0, 36), a(e(ATTACK, 0)), c(0x9FF9B5, 0x81F99E, 0x17DD62, 0x008A25))));
				r(24, lapislazuli = v(t("lapislazuli", 4, 62, m(2, 0, 8, 10, 18, 0), a(e(ATTACK, 0)), c(0xA2B7E8, 0x4064EC, 0x224BD5, 0x0A33C2))));
				r(25, enderdragon = v(t("enderdragon", 5, 61, m(3, 0, 34, 0, 10, 0), a(e(ATTACK, 20)), c(0x000000, 0x181818, 0x181818, 0xA500E2))));
				r(26, witherskeleton = v(t("witherskeleton", 4, 69, m(0, 11, 10, 4, 1, 0), a(e(ATTACK, 17)), c(0x505252, 0x1C1C1C, 0x1C1C1C, 0x060606))));
				r(27, wither = v(t("wither", 5, 52, m(0, 8, 10, 3, 1, 1), a(e(ATTACK, 25)), c(0x181818, 0x3C3C3C, 0x141414, 0x557272))));
				r(28, thunder = v(t("thunder", 3, 18, m(3, 10, 3, 8, 0, 0), a(e(ATTACK, 8)), c(0xB4FFFF, 0x4D5670, 0x4D5670, 0xFFEB00))));
				r(29, chicken = v(t("chicken", 1, 39, m(0, 0, 1, 0, 10, 7), a(e(ATTACK, 1)), c(0xFFDFA3, 0xFFFFFF, 0xFFFFFF, 0xD93117))));
				r(30, furnace = v(t("furnace", 2, 72, m(0, 2, 0, 10, 0, 11), a(e(ATTACK, 1)), c(0xFFFFFF, 0xFF7F19, 0x8E8E8E, 0x383838))));
				r(31, magentaglazedterracotta = v(t("magentaglazedterracotta", 3, 60, m(0, 1, 0, 10, 6, 4), a(e(ATTACK, 0)), c(0xFFFFFF, 0xF4B5CB, 0xCB58C2, 0x9D2D95))));
				r(32, bread = v(t("bread", 2, 35, m(0, 0, 0, 10, 9, 8), a(e(ATTACK, 0)), c(0xCC850C, 0x9E7325, 0x654B17, 0x3F2E0E))));
				r(33, daytime = v(t("daytime", 1, 88, m(1, 0, 10, 7, 7, 6), a(e(ATTACK, 0)), c(0xFFE260, 0xAACAEF, 0x84B5EF, 0xFFE7B2))));
				r(34, night = v(t("night", 1, 83, m(0, 7, 10, 0, 7, 26), a(e(ATTACK, 0)), c(0xFFE260, 0x2C2C2E, 0x0E0E10, 0x2D4272))));
				r(35, morning = v(t("morning", 2, 85, m(1, 8, 10, 8, 12, 8), a(e(ATTACK, 0)), c(0xFFE260, 0x91C4D9, 0x4570A6, 0xFF7017))));
				r(36, fine = v(t("fine", 1, 22, m(1, 0, 10, 0, 12, 0), a(e(ATTACK, 0)), c(0xB4FFFF, 0xAACAEF, 0x84B5EF, 0xffe7b2))));
				r(37, rain = v(t("rain", 2, 25, m(0, 0, 10, 0, 12, 0), a(e(ATTACK, 1)), c(0xB4FFFF, 0x4D5670, 0x4D5670, 0x2D40F4))));
				r(38, plains = v(t("plains", 1, 79, m(0, 0, 0, 3, 18, 10), a(e(ATTACK, 0)), c(0x80FF00, 0xD4FF82, 0x86C91C, 0xBB5400))));
				r(39, forest = v(t("forest", 2, 83, m(0, 0, 2, 12, 32, 10), a(e(ATTACK, 1)), c(0x80FF00, 0x7B9C62, 0x89591D, 0x2E6E14))));
			}
