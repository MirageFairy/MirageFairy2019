...
enum class CompressedMaterialCard(
    ...
    APATITE_BLOCK(1, 0, "apatite_block", "blockApatite", "blockApatite", "Block of Apatite", "燐灰石ブロック", NormalBlockModel, HardnessClass.HARD, 0, { SoundType.STONE }, false, { Material.IRON }, true, 0, 0, 0.0f),
    FLUORITE_BLOCK(1, 1, "fluorite_block", "blockFluorite", "blockFluorite", "Block of Fluorite", "蛍石ブロック", NormalBlockModel, HardnessClass.HARD, 0, { SoundType.STONE }, false, { Material.IRON }, true, 0, 0, 0.0f),
    SULFUR_BLOCK(1, 2, "sulfur_block", "blockSulfur", "blockSulfur", "Block of Sulfur", "硫黄ブロック", NormalBlockModel, HardnessClass.HARD, 0, { SoundType.STONE }, false, { Material.IRON }, true, 0, 0, 0.0f),
    CINNABAR_BLOCK(1, 3, "cinnabar_block", "blockCinnabar", "blockCinnabar", "Block of Cinnabar", "辰砂ブロック", NormalBlockModel, HardnessClass.HARD, 0, { SoundType.STONE }, false, { Material.IRON }, true, 0, 0, 0.0f),
    MOONSTONE_BLOCK(1, 4, "moonstone_block", "blockMoonstone", "blockMoonstone", "Block of Moonstone", "月長石ブロック", NormalBlockModel, HardnessClass.VERY_HARD, 0, { SoundType.STONE }, false, { Material.IRON }, true, 0, 0, 0.0f),
    MAGNETITE_BLOCK(1, 5, "magnetite_block", "blockMagnetite", "blockMagnetite", "Block of Magnetite", "磁鉄鉱ブロック", NormalBlockModel, HardnessClass.HARD, 0, { SoundType.STONE }, false, { Material.IRON }, true, 0, 0, 0.0f),
    PYROPE_BLOCK(1, 6, "pyrope_block", "blockPyrope", "blockPyrope", "Block of Pyrope", "パイロープブロック", NormalBlockModel, HardnessClass.VERY_HARD, 0, { SoundType.STONE }, false, { Material.IRON }, true, 0, 0, 0.0f),
    SMITHSONITE_BLOCK(1, 7, "smithsonite_block", "blockSmithsonite", "blockSmithsonite", "Block of Smithsonite", "スミソナイトブロック", NormalBlockModel, HardnessClass.SOFT, 0, { SoundType.STONE }, false, { Material.IRON }, true, 0, 0, 0.0f),
    CHARCOAL_BLOCK(1, 8, "charcoal_block", "blockCharcoal", "blockCharcoal", "Block of Charcoal", "木炭ブロック", NormalBlockModel, HardnessClass(5.0f, "pickaxe", 0), 20 * 10 * 8 * 9, { SoundType.STONE }, false, { Material.ROCK }, false, EnumFlammability.VERY_SLOW.value, EnumFireSpreadSpeed.VERY_SLOW.value, 0.0f),
    MIRAGE_FLOWER_LEAF_BLOCK(1, 9, "mirage_flower_leaf_block", "blockLeafMirageFlower", "blockLeafMirageFlower", "Block of Mirage Flower Leaf", "ミラージュフラワーの葉ブロック", NormalBlockModel, HardnessClass(2.0f, "axe", 0), 0, { SoundType.GLASS }, false, { Material.LEAVES }, false, EnumFlammability.SLIGHTLY_SLOW.value, EnumFireSpreadSpeed.FAST.value, 0.0f),
    MIRAGIUM_INGOT_BLOCK(1, 10, "miragium_ingot_block", "blockMiragium", "blockMiragium", "Block of Miragium", "ミラジウムブロック", NormalBlockModel, HardnessClass(5.0f, "pickaxe", 1), 0, { SoundType.METAL }, false, { Material.IRON }, false, 0, 0, 0.0f),
    MIRAGIUM_DUST_BLOCK(1, 11, "miragium_dust_block", "blockDustMiragium", "blockDustMiragium", "Block of Miragium Dust", "ミラジウムの粉ブロック", NormalBlockModel, HardnessClass(0.5f, "shovel", 0), 0, { SoundType.SNOW }, true, { Material.SAND }, false, 0, 0, 0.0f),
    NEPHRITE_BLOCK(1, 12, "nephrite_block", "blockNephrite", "blockNephrite", "Block of Nephrite", "ネフライトブロック", NormalBlockModel, HardnessClass.HARD, 0, { SoundType.STONE }, false, { Material.IRON }, true, 0, 0, 0.0f),
    TOPAZ_BLOCK(1, 13, "topaz_block", "blockTopaz", "blockTopaz", "Block of Topaz", "トパーズブロック", NormalBlockModel, HardnessClass.SUPER_HARD, 0, { SoundType.STONE }, false, { Material.IRON }, true, 0, 0, 0.0f),
    TOURMALINE_BLOCK(1, 14, "tourmaline_block", "blockTourmaline", "blockTourmaline", "Block of Tourmaline", "トルマリンブロック", NormalBlockModel, HardnessClass.VERY_HARD, 0, { SoundType.STONE }, false, { Material.IRON }, true, 0, 0, 0.0f),
    VELOPEDA_BLOCK(1, 15, "velopeda_block", "blockVelopeda", "blockLeafMirageFairyVelopeda", "Block of Velopeda Leaf", "呪いの布", NormalBlockModel, HardnessClass(0.8f, "shovel", 0), 0, { SoundType.CLOTH }, false, { Material.CLOTH }, false, EnumFlammability.FAST.value, EnumFireSpreadSpeed.MEDIUM.value, 1.0f),
