...
class PluginOreSeedDrop : IModPlugin {
    ...
    override fun registerCategories(registry: IRecipeCategoryRegistration) {
        registry.addRecipeCategories(object : IRecipeCategory<IRecipeWrapper> {
            ...
            override fun getIcon(): IDrawable? = registry.jeiHelpers.guiHelper.createDrawableIngredient(ItemStack(ModuleOre.blockOre1, 1, EnumVariantOre1.APATITE_ORE.metadata))
